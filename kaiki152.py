...
df["log(100-201902知名度)*weightedPV1_past"] = df["log(100-201902知名度)"] * df["weightedPV1_past"]
df["(100-201902知名度)*weightedPV1_past"] = df["100-201902知名度"] * df["weightedPV1_past"]

df["100-201902知名度::"] = df["100-202208知名度"] / (201 - df["201902知名度"])
df["log(100-201902知名度)*weightedPV1_past::"] = df["log(100-201902知名度)*weightedPV1_past"] / (201 - df["201902知名度"])
df["(100-201902知名度)*weightedPV1_past::"] = df["(100-201902知名度)*weightedPV1_past"] / (201 - df["201902知名度"])

ex = ["100-201902知名度::", "log(100-201902知名度)*weightedPV1_past::", "(100-201902知名度)*weightedPV1_past::"]
...
mre_lin  = mean_relative_error(y_test, y_pred)
...
mape_lasso = mean_absolute_percentage_error(y_test, y_lasso_pred)
mre_lasso  = mean_relative_error(y_test, y_lasso_pred)
