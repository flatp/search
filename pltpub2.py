...
# ==== データ読み込み ====
df = pd.read_csv("alllist2.csv")

# ==== 対象列 ====
y_cols = ["pop_diff", "aware_diff", "202302人気度", "202302知名度"]
x_cols = ["pub_score1", "pub_score2", "pub_score3"]
...
# ==== 図の準備 ====
fig, axes = plt.subplots(len(y_cols), len(x_cols), figsize=(15, 15))
...
plt.tight_layout()
plt.savefig("correlation_pubscore_regression2.png", dpi=300, bbox_inches="tight")
plt.show()

print("✅ 出力完了: correlation_pubscore_regression2.png に保存されました。")
