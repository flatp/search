...
df["202208知名度^2"] = df["202208知名度"] ** 2
df["(100-202208知名度)^2"] = df["100-202208知名度"] ** 2
...
df["100-202208知名度::"] = df["100-202208知名度"] * np.log10(df["202208知名度"]+1) / (101 - df["202208知名度"])
df["log(100-202208知名度)*weightedPV1::"] = df["log(100-202208知名度)*weightedPV1"] * np.log10(df["202208知名度"]+1) / (101 - df["202208知名度"])
df["(100-202208知名度)*weightedPV1::"] = df["(100-202208知名度)*weightedPV1"] * np.log10(df["202208知名度"]+1) / (101 - df["202208知名度"])
...
# y = df["aware_diff"] * np.log10(df["202208知名度"]+1) / (101 - df["202208知名度"]) 
