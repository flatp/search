...
## "log(100-202208知名度)^2", "log(100-202208知名度)*weightedPV1", "(100-202208知名度)*weightedPV1" -> 知名度変化量(100 - 202208知名度)/log(202208知名度)

![a](kaiki45.png)

```
========== Linear Regression ==========
Coefficients: [-1.55364879e+01 -7.52006244e-04  5.94191820e-05]
Intercept: 27.628988149341193
R2: 0.4555611738083172
RMSE: 67.5109135169509

========== Lasso Regression ==========
R2: 0.4555609490177185
RMSE: 67.5109274540696
Intercept: 27.578997670957587
Coefficients:
log(100-202208知名度)^2             -15.511386
log(100-202208知名度)*weightedPV1    -0.000752
(100-202208知名度)*weightedPV1        0.000059
dtype: float64
```

## "log(100-202208知名度)^2", "log(100-202208知名度)*weightedPV1", "(100-202208知名度)*weightedPV1" -> 知名度変化量*50/202208知名度

![a](kaiki46.png)

```
========== Linear Regression ==========
Coefficients: [-4.41437347e-01 -2.83289772e-05  2.15534564e-06]
Intercept: 1.0150814396066095
R2: 0.40140951067874486
RMSE: 2.9712886645219214

========== Lasso Regression ==========
R2: 0.4009650569395852
RMSE: 2.972391551499732
Intercept: 0.9650909645393233
Coefficients:
log(100-202208知名度)^2             -0.416335
log(100-202208知名度)*weightedPV1   -0.000028
(100-202208知名度)*weightedPV1       0.000002
dtype: float64
```

## "100-202208知名度", "log(100-202208知名度)*weightedPV1", "(100-202208知名度)*weightedPV1" -> 知名度変化量(100 - 202208知名度)/log(202208知名度)

![a](kaiki47.png)

```
========== Linear Regression ==========
Coefficients: [-6.25251132e-01 -7.85630859e-04  6.03930888e-05]
Intercept: 16.31720748461299
R2: 0.45397743035523885
RMSE: 67.6090350311826

========== Lasso Regression ==========
R2: 0.453977280991666
RMSE: 67.60904427835194
Intercept: 16.315764836713708
Coefficients:
100-202208知名度                    -0.625205
log(100-202208知名度)*weightedPV1   -0.000786
(100-202208知名度)*weightedPV1       0.000060
dtype: float64
```
...
## "100-201902知名度", "log(100-201902知名度)*weightedPV1_past", "(100-201902知名度)*weightedPV1_past" -> 知名度変化量(100-201902知名度)/log(201902知名度)

![a](kaiki50.png)

```
========== Linear Regression ==========
Coefficients: [-4.35186815e+00 -7.12810779e-04  4.63849886e-05]
Intercept: 60.87888380949461
R2: 0.6265060451112784
RMSE: 330.9651212489897

========== Lasso Regression ==========
R2: 0.626506295916429
RMSE: 330.96501012567705
Intercept: 60.87772813819625
Coefficients:
100-201902知名度                         -4.351829
log(100-201902知名度)*weightedPV1_past   -0.000713
(100-201902知名度)*weightedPV1_past       0.000046
dtype: float64
```
$$ \frac{知名度変化量 \times (100-知名度)}{log(知名度)} = f(t) \( a \times (100-知名度)(b + PV) + c \times log(100-知名度)PV \) $$
...
$$ \frac{知名度変化量 \times (100-知名度)}{log(知名度)} = a \times (100-知名度)(b f(t) + PV) + c \times log(100-知名度)PV $$

![a](model58.png)
![a](model59.png)

$$ \frac{知名度変化量 \times (100-知名度)}{log(知名度)} = \( a \times (100-知名度) + b \times log(100-知名度) \) PV $$

```
========== Linear Regression ==========
Coefficients: [-4.34158244e-04  3.41455079e-05]
Intercept: -67.51806241401677
R2: 0.6346625370418771
RMSE: 327.3313064302647

========== Lasso Regression ==========
R2: 0.6346625370240726
RMSE: 327.33130643824086
Intercept: -67.51806248576436
Coefficients:
log(100-201902知名度)*weightedPV1_past   -0.000434
(100-201902知名度)*weightedPV1_past       0.000034
dtype: float64

========== Linear Regression ==========
Coefficients: [-4.94731107e-04  4.78072125e-05]
Intercept: -3.3113007748396406
R2: 0.4425480822470387
RMSE: 68.31296682096735

========== Lasso Regression ==========
R2: 0.44254808197339723
RMSE: 68.31296683773405
Intercept: -3.3113012063642238
Coefficients:
log(100-202208知名度)*weightedPV1   -0.000495
(100-202208知名度)*weightedPV1       0.000048
dtype: float64
```
![a](model70.png)
![a](model71.png)
...
yの重みは残余キャパシティを対数の正則化項によって初期の不安定性の抑制したもの

## ("100-202208知名度", "log(100-202208知名度)*weightedPV1", "(100-202208知名度)*weightedPV1")log(202208知名度)/知名度変化量(100-202208知名度) -> 知名度変化量

![a](kaiki70.png)

```
========== Linear Regression ==========
Coefficients: [-9.90656199e-01 -1.99534219e-04  2.94155416e-05]
Intercept: 1.6966067537503977
R2: 0.2034724083425512
RMSE: 2.25784875346346
MAPE: 58710.65108624933
MRE : -58708.592547303546

========== Lasso Regression ==========
R2: 0.20202574067351398
RMSE: 2.259898195986721
MAPE: 58466.180134118935
MRE : -58464.11647542475
Intercept: 1.2909564468014945
Coefficients:
100-202208知名度::                    -0.746399
log(100-202208知名度)*weightedPV1::   -0.000200
(100-202208知名度)*weightedPV1::       0.000029
dtype: float64
```

## ("100-201902知名度", "log(100-201902知名度)*weightedPV1_past", "(100-201902知名度)*weightedPV1_past")log(201902知名度)/知名度変化量(100-201902知名度) -> 知名度変化量

![a](kaiki71.png)

```
========== Linear Regression ==========
Coefficients: [-1.08579955e+01 -1.48519860e-04  3.09934986e-05]
Intercept: 11.833359245054385
R2: 0.7371615633809672
RMSE: 5.047660151733642
MAPE: 50782.28203663002
MRE : 50780.72059954092

========== Lasso Regression ==========
R2: 0.7367780084795663
RMSE: 5.051341784108309
MAPE: 51206.12798801529
MRE : 51204.57205054286
Intercept: 11.55980362848972
Coefficients:
100-201902知名度::                         -10.692179
log(100-201902知名度)*weightedPV1_past::    -0.000149
(100-201902知名度)*weightedPV1_past::        0.000031
dtype: float64
```

## ("100-202208知名度", "log(100-202208知名度)*weightedPV1", "(100-202208知名度)*weightedPV1")log(202208知名度)/知名度変化量(200-202208知名度) -> 知名度変化量
...
Intercept: 0.7852767812436832
R2: 0.24612939597799388
RMSE: 2.196558827182867
MAPE: 45697.917206081904
MRE : -45695.86679039121

========== Lasso Regression ==========
R2: 0.242792999252035
RMSE: 2.2014141040812647
MAPE: 48000.80544428821
MRE : -47998.79423697488
Intercept: 0.48936933509179337
Coefficients:
100-202208知名度::                    -1.099633
log(100-202208知名度)*weightedPV1::   -0.000875
(100-202208知名度)*weightedPV1::       0.000112
dtype: float64
```

## ("100-201902知名度", "log(100-201902知名度)*weightedPV1_past", "(100-201902知名度)*weightedPV1_past")log(201902知名度)/知名度変化量(200-201902知名度) -> 知名度変化量

![a](kaiki73.png)

```
========== Linear Regression ==========
Coefficients: [-1.11833298e+01 -7.14144402e-04  1.15879100e-04]
Intercept: -1.8944882012059316
R2: 0.7780677276744234
RMSE: 4.638268648422347
MAPE: 36335.4245455081
MRE : 36334.39897044787

========== Lasso Regression ==========
R2: 0.7782916732007339
RMSE: 4.635927885471106
MAPE: 37508.138095512455
MRE : 37507.0897458618
Intercept: -2.0924093455756703
Coefficients:
100-201902知名度::                         -10.530062
log(100-201902知名度)*weightedPV1_past::    -0.000686
(100-201902知名度)*weightedPV1_past::        0.000114
dtype: float64
```
